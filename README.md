...
> 希望自行修改并生成自定义 `geoip.dat` 文件？查看仓库 [@IceCodeNew/geoip](https://github.com/IceCodeNew/geoip)。
...
- **geoip.dat**：
  - [https://github.com/IceCodeNew/v2ray-rules-dat/releases/latest/download/geoip.dat](https://github.com/IceCodeNew/v2ray-rules-dat/releases/latest/download/geoip.dat)
...
- **geosite.dat**：
  - [https://github.com/IceCodeNew/v2ray-rules-dat/releases/latest/download/geosite.dat](https://github.com/IceCodeNew/v2ray-rules-dat/releases/latest/download/geosite.dat)
